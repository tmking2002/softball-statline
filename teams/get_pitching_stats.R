...
write.csv(distinct(rbind(readRDS(url("https://github.com/sportsdataverse/softballR-data/raw/main/data/d1_pitching_box_scores_2015.RDS")))) %>% get_stats(., 2015),
          "teams/data/pitching_stats/pitching_stats_2015.csv")
