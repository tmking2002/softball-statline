box <- readRDS("~/Projects/softballR-data/data/d1_hitting_box_scores_2015.RDS") 
...
write.csv(stats, "~/Projects/softball-statline/teams/data/rosters/d1_hitting_stats_2015.csv")
